<div class="container-fluid bg-dark text-white py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
  <div class="row pt-5">
        <div class="col-lg-5 col-md-12">
            <h5 class="text-white text-uppercase mb-4" style="letter-spacing: 5px;"><b>CHREC Registration</b></h5>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 mb-0">
                    <h5 class="text-white text-uppercase mb-4" style="letter-spacing: 5px;"><b>Get In Touch</b></h5>
                    <p><i class="fa fa-map-marker-alt mr-2"></i>3rd Floor, CUCRID Building, Covenant University</p>
                    <p><i class="fa fa-phone-alt mr-2"></i>08064265189, 07037849186</p>
